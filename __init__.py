...
def initdb_command():
    ...
    user6 = User('Nancy','Conway','f@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user7 = User('Morgan','Wilson','g@gmail.com','1111111111', generate_password_hash('123'),'therapist')
    user8 = User('Jake','Holden','h@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user9 = User('Claire','Morris','i@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user10 = User('Stan','Thomas','j@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user11 = User('Grant','Black','k@gmail.com','1111111111', generate_password_hash('123'),'therapist')
    user12 = User('Michael','Stanley','l@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user13 = User('Kat','Eckard','m@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user14 = User('Jack','Hoffman','n@gmail.com','1111111111', generate_password_hash('123'),'patient')
    user15 = User('Ruger','Emmet','o@gmail.com','1111111111', generate_password_hash('123'),'therapist')
